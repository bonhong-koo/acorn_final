...
public class UserDaoTest {
	...
	void login() throws SQLException {
		...
		// 1.
		mapper.deleteAll();		
		assertEquals(mapper.getCount(), 0);
		
		// 2.
		int flag = mapper.doSave(dto01);
		assertEquals(flag, 1);
		assertEquals(mapper.getCount(), 1);
		
		// 3.
		int idCheck = mapper.idCheck(dto01);
		assertEquals(idCheck, 1);
		
		// 4.
		int idPassCheck = mapper.idPasswordCheck(dto01);
		assertEquals(idPassCheck, 1);
